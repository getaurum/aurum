...
const T = {
  en: {
    ...
    hero_sub: "Instant market analysis on every luxury piece — bag, watch, jewellery...\nIs it priced right? Is now the right time to buy or sell?\nAurum tells you clearly based on real data.",
    ...
    scan_sub: "Photograph the piece. Aurum identifies the house, the model and analyses material, colour, size and condition — and tells you clearly if it's worth the price, a sound piece to acquire, or one to walk away from.",
...
limit_title: "You've used your 3 free analyses.",
  ...
  fr: {
    ...
    hero_sub: "Analyse de marché instantanée sur toute pièce de luxe — sac, montre, bijou...\nEst-elle au bon prix ? Est-ce le bon moment pour acheter ou pour vendre ?\nAurum vous répond clairement sur la base de données réelles.",
    ...
    scan_sub: "Photographiez la pièce. Aurum identifie la maison, le modèle et analyse matière, couleur, taille et état — et vous dit clairement si elle vaut son prix, si c'est une bonne pièce à acquérir, ou si vous devez passer votre chemin.",
...
limit_title: "Vos 3 analyses gratuites sont utilisées.",
  ...
  ja: {
    ...
    hero_sub: "すべてのラグジュアリーアイテムの本当の価値を知る — バッグ、時計、ジュエリー...\n適正価格？今が買い時？売り時？\n{year}年のリアルデータでAurumが明確にお答えします。",
    ...
    scan_label: "即時判定",
    scan_title: "本当の価値は？\n今がその時？",
    scan_sub: "アイテムを撮影するだけ。Aurumがブランドとモデルを特定し、素材・色・サイズ・状態を分析。価格が妥当か、購入すべきか、見送るべきかを明確にお伝えします。",
...
{isSignedIn && <SignOutButton><button style={{ background: "transparent", border: "1px solid rgba(255,255,255,0.1)", borderRadius: 20, padding: "6px 14px", cursor: "pointer", fontFamily: "'DM Sans',sans-serif", fontSize: 11, color: "rgba(255,255,255,0.55)" }}>Déconnexion</button></SignOutButton>}
        ...
        <div className={`hero ${mounted ? "in" : ""}`}>
          ...
          <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 10, fontStyle: "italic", color: "rgba(255,255,255,0.88)", maxWidth: 600, margin: "0 auto 44px", lineHeight: 1.5 }}>
