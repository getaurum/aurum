...
limit_title: "Vos 3 analyses gratuites sont utilisées.",
  ...
  ja: {
    ...
    hero_sub: "すべてのラグジュアリーアイテムの本当の価値を知る — バッグ、時計、ジュエリー、衣類。\n適正価格？今が買い時？売り時？\n{year}年のリアルデータでAurumが明確にお答えします。",
