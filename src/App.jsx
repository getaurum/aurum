...
limit_title: "You've used your 3 free analyses.",
    limit_sub: "Join the list now and lock in launch pricing — rates go up after launch.",
    ...
    waitlist_desc: "Be among the first members to access Aurum. Sign up now to lock in launch pricing.",
...
limit_title: "Vos 3 analyses gratuites sont utilisées.",
    limit_sub: "Inscrivez-vous maintenant et bénéficiez du tarif de lancement — les prix augmentent après le lancement.",
    ...
    waitlist_desc: "Soyez parmi les premiers membres à accéder à Aurum. Inscrivez-vous maintenant pour bénéficier du tarif de lancement.",
...
limit_title: "3回の無料分析を使用しました。",
    limit_sub: "今すぐ登録してローンチ価格を確保しましょう — ローンチ後は価格が上がります。",
    ...
    early_access: "早期アクセス ✦",
    be_first: "最初に知る。",
    waitlist_desc: "Aurumに最初にアクセスできるメンバーになりましょう。今すぐ登録してローンチ価格を確保しましょう。",
