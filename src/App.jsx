...
const T = {
  en: {
    ...
    hero_sub: "Instant market analysis on every luxury piece —\nbag, watch, jewellery, clothing.\nIs it priced right?\nIs now the right time to buy or sell?\nAurum tells you clearly based on real data.",
...
limit_title: "You've used your 3 free analyses.",
  ...
  fr: {
    ...
    hero_sub: "Analyse de marché instantanée sur toute pièce de luxe —\nsac, montre, bijou, vêtement.\nEst-elle au bon prix ?\nEst-ce le bon moment pour acheter ou pour vendre ?\nAurum vous répond clairement sur la base de données réelles.",
...
limit_title: "Vos 3 analyses gratuites sont utilisées.",
  ...
  ja: {
    ...
    hero_sub: "すべてのラグジュアリーアイテムの本当の価値を知る —\nバッグ、時計、ジュエリー、衣類。\n適正価格？\n今が買い時？売り時？\n{year}年のリアルデータでAurumが明確にお答えします。",
